...
public class HomeAdapter extends ArrayAdapter<ModelOne> {
    Context context;
    int resource;
    ArrayList<ModelOne> gridobjects;
    boolean saveLang;

    public HomeAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull ArrayList<ModelOne> gridobjects, boolean saveLang) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_home_recycle, null);
            layout = convertView.findViewById(R.id.relative);
            imageView = convertView.findViewById(R.id.image1);
            textViewTitle = convertView.findViewById(R.id.text_title1);
            textViewCount = convertView.findViewById(R.id.text_count);
